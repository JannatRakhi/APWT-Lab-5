...
class UserController extends Controller
{
    ...
    public function listingUser(Request $request)
    {
        ...
        if ($check) {
            $request
                ->session()
                ->flash('database-error', 'Email already taken!');
    ...
    function updateUserProfile(Request $request)
    {
        ...
        $request
            ->session()
            ->flash('user-update', 'Profile Update successfully');
    ...
    public function UserAPIPost(Request $request)
    {
        ...
        $var->save();
        // return redirect(
        //     'file:///C:/xampp/htdocs/Advance-Web-Tech/APWT-TASK-5/OutSide%20Code/index.html'
        // );
